...
const verticals = [
  {
    id: 'trika',
    title: 'Trika',
    description: 'Trika is offered as a sacred spiritual path rooted in the wisdom of a profound tradition that explores the union of consciousness (Shiva) and energy (Shakti)',
  ...
  },
  {
    id: 'vastu',
    title: 'Vastu',
    description: 'Vastu Shastra is the ancient Vedic science of architecture, energy flow, and spatial harmony.',
  ...
  },
  {
    id: 'sound-healing',
    title: 'Sound Healing',
    description: 'is one of the oldest forms of healing — a sacred vibrational medicine that helps restore harmony to the body, mind, emotions, and energy field',
